...
from server.domain.phases import Phase, is_generate_phase
from server.domain.schemas import GenerateRequest
from server.phases import drafting, final_content
from server.sse import stream_with_disconnect_guard
